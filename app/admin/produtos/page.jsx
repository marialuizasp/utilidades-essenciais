...
export default function AdminProdutos() {
  ...
  return <main className="min-h-screen overflow-y-auto bg-slate-50 px-4 py-8 text-slate-900 sm:px-8" style={{height:'100dvh',backgroundColor:'#f8fafc',color:'#0f172a',fontFamily:'Arial, sans-serif'}}>
    <div className="mx-auto max-w-6xl space-y-6">
      <header className="space-y-2"><a href="/" className="text-sm text-emerald-700 hover:underline">← Voltar à vitrine</a><p className="text-xs font-bold uppercase tracking-widest text-emerald-700">Utilidades Essenciais · Administração</p><h1 className="text-3xl font-bold sm:text-4xl">Cadastro de produtos</h1><p className="text-slate-600">Cadastre até 100 produtos por lote. O painel verifica duplicatas antes de inserir na sua planilha.</p></header>
